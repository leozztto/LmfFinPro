...
import { formatCep, formatCnpj, formatCpf, formatPhone } from '@/shared/format/mask'
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-8">
            ...
            <section className="space-y-4">
              ...
              <FormField label="Logradouro" htmlFor="address.street" error={errors.address?.street?.message}>
                <Input id="address.street" type="text" placeholder="Rua, avenida..." {...register('address.street')} />
              </FormField>
              <div className="grid gap-4 sm:grid-cols-3">
                <FormField label="Bairro" htmlFor="address.neighborhood" error={errors.address?.neighborhood?.message}>
                  <Input id="address.neighborhood" type="text" {...register('address.neighborhood')} />
                </FormField>
                ...
                <FormField label="Estado" htmlFor="address.state" error={errors.address?.state?.message}>
                  <Select id="address.state" defaultValue="" {...register('address.state')}>
                    <option value="" disabled>
                      UF
                    </option>
