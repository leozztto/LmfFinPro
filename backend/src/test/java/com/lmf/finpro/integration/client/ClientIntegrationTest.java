...
class ClientIntegrationTest extends AbstractIntegrationTest {
    ...
    void createsListsUpdatesAndDeletesOwnClient() {
        ...
        ResponseEntity<ClientResponse[]> listResponse =
                restTemplate.exchange(
                        "/api/clients",
                        HttpMethod.GET,
        ...
        ClientRequest updateRequest =
                new ClientRequest(
                        ...
                        "#FF0000",
                        true);
        ResponseEntity<ClientResponse> updateResponse =
                restTemplate.exchange(
    ...
    void createsClientWithoutOptionalColorAndNotes() {
        ...
        ClientRequest createRequest =
                new ClientRequest(
                        "Cliente sem cor nem observações",
                        "cliente@example.com",
                        "11988887777",
                        DocumentType.CPF,
                        "11144477735",
    ...
    void rejectsClientMissingRequiredFields() {
        ...
        ClientRequest createRequest =
                new ClientRequest(
                        "Cliente incompleto", null, null, null, null, null, null, null, true);
    ...
    void cannotDeleteClientWithLinkedTransactions() {
        ...
        ClientRequest clientRequest =
                new ClientRequest(
                        ...
                        null,
                        true);
        ResponseEntity<ClientResponse> clientResponse =
                restTemplate.exchange(
                        "/api/clients",
                        HttpMethod.POST,
                        new HttpEntity<>(clientRequest, user.authHeaders()),
                        ClientResponse.class);
