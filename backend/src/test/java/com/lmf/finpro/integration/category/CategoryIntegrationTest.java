...
class CategoryIntegrationTest extends AbstractIntegrationTest {
    ...
    void createsListsAndUpdatesOwnCategory() {
        ...
        CategoryRequest createRequest =
                new CategoryRequest("Consultoria", CategoryType.INCOME, "#2E6E4E", "briefcase");
        ...
        CategoryRequest updateRequest =
                new CategoryRequest("Consultoria PJ", CategoryType.INCOME, "#2E6E4E", "briefcase");
    ...
    void categoryTypeCannotBeChangedOnUpdate() {
        ...
        CategoryRequest createRequest =
                new CategoryRequest("Freelas", CategoryType.EXPENSE, null, null);
        ResponseEntity<CategoryResponse> createResponse =
                restTemplate.exchange(
                        "/api/categories",
                        HttpMethod.POST,
        ...
        // Tenta trocar o tipo na edição: deve ser ignorado — transações já lançadas dependem do
        // tipo original.
        CategoryRequest updateRequest =
                new CategoryRequest("Freelas", CategoryType.INCOME, null, null);
        ResponseEntity<CategoryResponse> updateResponse =
                restTemplate.exchange(
                        "/api/categories/" + categoryId,
                        HttpMethod.PUT,
    ...
    void userCannotEditAnotherUsersCategory() {
        ...
        CategoryRequest createRequest =
                new CategoryRequest("Categoria da Ana", CategoryType.EXPENSE, null, null);
        ResponseEntity<CategoryResponse> createResponse =
                restTemplate.exchange(
                        "/api/categories",
                        HttpMethod.POST,
        ...
        ResponseEntity<ApiError> updateResponse =
                restTemplate.exchange(
                        "/api/categories/" + categoryId,
                        HttpMethod.PUT,
    ...
    void userCannotDeleteCategoryWithLinkedTransaction() {
        ...
        CategoryRequest categoryRequest =
                new CategoryRequest("Moradia", CategoryType.EXPENSE, null, null);
        ResponseEntity<CategoryResponse> categoryResponse =
                restTemplate.exchange(
                        "/api/categories",
                        HttpMethod.POST,
