...
class BudgetIntegrationTest extends AbstractIntegrationTest {
    ...
    void createsListsAndDeletesOwnBudget() {
        ...
        BudgetRequest createRequest =
                new BudgetRequest(categoryId, YearMonth.now(), BigDecimal.valueOf(500));
    ...
    void calculatesSpentValueFromExpensesInTheSameCategoryAndMonth() {
        ...
        BudgetRequest createRequest =
                new BudgetRequest(categoryId, currentMonth, BigDecimal.valueOf(500));
        ResponseEntity<BudgetResponse> createResponse =
                restTemplate.exchange(
                        "/api/budgets",
                        HttpMethod.POST,
    ...
    void rejectsBudgetWithZeroLimitValue() {
        ...
        BudgetRequest createRequest =
                new BudgetRequest(categoryId, YearMonth.now(), BigDecimal.ZERO);
    ...
    void userCannotAccessAnotherUsersBudget() {
        ...
        BudgetRequest createRequest =
                new BudgetRequest(categoryId, YearMonth.now(), BigDecimal.valueOf(300));
        ResponseEntity<BudgetResponse> createResponse =
                restTemplate.exchange(
                        "/api/budgets",
                        HttpMethod.POST,
